...
const std::string CARE_PERIODS = "* Care period: ";
...
public:
    ...
    //void print_patient_medicines(Params params); // ei k�yt�ss�
    ...
    //void print_patients_per_staff(Params params); // ei k�yt�ss�
    ...
    // apufukntio, jonka avulla saadaan vectorin parametrit oikeaan jarjestykseen
...
private:
    ...
    std::vector<std::pair<std::string, std::vector<CarePeriod*>>> Care_periods_all;
};
